...
public class GreatPrinter extends ClassVisitor {
	...
	private ArrayList<MessageMethod> methods = new ArrayList<MessageMethod>();
	private ArrayList<AutoGeneratedLambdaMessage> lambda = new ArrayList<>();
...
//	
	...
	public MethodVisitor visitMethod(final int access, final String name, final String descriptor,
		...
		if(!name.substring(0,7).equals("lambda$")) {
			messageMethod.setNameSource(source);
			messageMethod.setNamefunction(name);
			messageMethod.setDescriptorFunction(descriptor);
			methods.add(messageMethod);
		}
	...
	public void visitEnd() {
		lambda.forEach(AutoGeneratedLambdaMessage::generateCapture);
	}

	public ArrayList<MessageMethod> getMethods() {
		return methods;
	}

	public ArrayList<AutoGeneratedLambdaMessage> getLambda() {
		return lambda;
	}
